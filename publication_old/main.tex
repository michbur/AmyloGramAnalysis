...
Stefan R\"{o}diger\,$^{3}$,
Pawe\l{} Mackiewicz\,$^{1}$ and Ma\l{}gorzata Kotulska\,$^{4}$
...
and 
$^{4}$Wroc\l{}aw University of Science and Technology, Department of Biomedical 
...
amyloidogenic peptides and 1039 non-amyloidogenic peptides (1465 peptides in 
total).

  Sequences shorter than six amino acids and longer than 25 amino acids 
(8 and 27 sequences respectively) were 
...
AmyloGram has the highest AUC and MCC among all tested classifiers. Is has 
...
MCC.
  ...
  The specificity of AmyloGram is lower than the specificity of PASTA2, which 
is the consequence of the usage of a threshold value optimized for 0.95 
specificity for the latter. If the AmyloGram also utilizes such threshold, it 
...
AmyloGram predicts more true amyloids. 
