...
For each group in encoding **a**, we choose the minimum distance between the group and any group belonging to the encoding **b**. The normalization factor is equal to the sum of minimum distances for each group in **a**.

$$
n_f = \sum_{i \in 1, 2, 3} \min \left( \bar{d}_i \right) 
$$

Problematic situations:  
1. Unequal number of groups.  
2. Source of properties to calculate mean properties of groups.  
