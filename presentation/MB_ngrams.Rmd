...
author: "Michal Burdukiewicz, Piotr Sobczyk, Pawel Mackiewicz, Malgorzata Kotulska"
date: "21-04-2016"
output:
...
Amyloids are proteins associated with the number of clinical disorders (e.g. Alzheimer's or Creutzfeldt-Jakob’s diseases) characterized by the occurence of hot-spots.
...
Sequence before encoding: YFGST   
Sequence after encoding: 44166 
...
Sensitivity: correctly recognize amyloids.   
Specificity: correctly recognize nonamyloids.   
...
-6L), .Names = c("Classifier", "AUC", "MCC", "Sensitivity", "Specificity"
  ...
  datatable(rownames = FALSE, filter = "none", 
          options = list(dom = 't')) %>%  formatRound(2, 4)
```
