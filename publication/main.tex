...
>>>>>>> 6123719ab4b2bb85aecb352ceb740c559d7a728f
...
%
% Gdzieœ tu przyda³by siê rozk³ad d³ugoœci peptydów, ze szczególnym uwzglêdnieniem granic 3 zbiorów.
%
% ^.
devised analysis framework and the latter were too diversified and rare, 
hampering the proper analysis.
...
%
% rzeczywiœcie a¿ tyle alfabetów by³o ?
%
% ^.
...
% > uncorrelated
%
% czy jest jakiœ zwi¹zek z tym czy skorelowane lub (!) nieskorelowane?
%
% ^.
...
% > During 
%
% Przed tym tekstem da³abym informacje o 3 zbiorach z ró¿nymi granicami d³ugoœci. Wtedy fa³szywe pozytywy w zbiorze "do 15" nie sa tak groŸne i niesprawdzalne
%
% ^.
>>>>>>> 6123719ab4b2bb85aecb352ceb740c559d7a728f
...
%
% ka¿dy heksamer dosta³ tak¹ sam¹ etykietê jak peptyd z którego pochodzi. Np. z peptydu amyloidogennego o d³ugoœci 8 wyodrêbniono 3 heksamery i ka¿demu z nich przypisano etykietê "amyloidogenny"
%
...
% > evade 
%
% proponujê "weaken". Wyjaœniê podczas spotkania
%
% ^.
...
% > set 
%
% sets? Tam sa 3 zbiory i ten 15-aminokwasowy jest najd³uzszy. Dla heksamerów nie mamy takiego problemu
%
% ^.
the extraction of probable hot-spots.
>>>>>>> 6123719ab4b2bb85aecb352ceb740c559d7a728f
...
%
% Chyba dobrze by³oby te iloœci sekwencji wyraŸnie podaæ
%
% ^.
...
%
% jak rozumiem to jest synonim do "encoding". Jesli tak, to  wczesniej trzeba te¿ wprowadziæ to pojecie.
%
% ^.
...
%
% Jak odczytywaæ boxplot skoro na wykresie s¹ 4 alfabety? 
%
% ^ <michalburdukiewicz@gmail.com> 2016-03-31T17:22:30.733Z:
%
% Ka¿dy z podwykresów przedstawia wszystkie alfabety. Wiêkszoœæ z nich jest niewidoczna, bo jest "ukryta" w wykresie pude³kowym. Kolorami zaznaczy³em alfabety z literatury, najlepszy alfabet i pe³ny alfabet.
%
...
%
% Przerobione zdanie, czy zachowa³am intencjê?
%
% ^.
...
% > selected encoding
%
% jaka róznica miedzy tymi dwoma wielkoœciami?
%
% ^.
...
% * <kotulska@gmail.com> 2016-04-24T20:05:53.387Z:
%
% > Surprisingly
%
% czemu "surprisingly" ?
...
%
% co to s¹ kodowania identyczne z najlepszym? Jest ich wiêcej najlepszych?
%
% ^ <michalburdukiewicz@gmail.com> 2016-03-31T17:13:57.599Z:
%
% ró¿ne cechy fizykochemiczne mog¹ daæ takie samo kodowanie aminokwasów, co znaczy, ¿e czêœæ alfabetów mia³a swoje duplikaty. Alfabet, który mia³ najlepszy performance móg³ powstaæ z 11 ró¿nych kombinacji cech fizykochemicznych. Akapit wy¿ej omawiamy cechy fizykochemiczne wspólne, które wyst¹pi³y w ka¿dej z tych kombinacji.
%
% ^.
...
% > yloids. 
%
% Brakuje mi informacji o strukturze odleg³oœciowej najlepszych n-gramów.
%
% ^.
...
%
% Trzeba streœciæ najwa¿niejsze kroki analizy i podsumowaæ wyniki
%
% ^.
